...
const bookingRate = Number(__ENV.K6_CORRECTNESS_BOOKING_RPS || "100");
const onlineRate = Number(__ENV.K6_CORRECTNESS_ONLINE_RPS || "70");
const offlineRate = Number(__ENV.K6_CORRECTNESS_OFFLINE_RPS || "5");
const mixedOnlineRate = Number(__ENV.K6_CORRECTNESS_MIXED_ONLINE_RPS || "50");
const mixedOfflineRate = Number(__ENV.K6_CORRECTNESS_MIXED_OFFLINE_RPS || "5");
const invalidRate = Number(__ENV.K6_CORRECTNESS_INVALID_RPS || "20");
