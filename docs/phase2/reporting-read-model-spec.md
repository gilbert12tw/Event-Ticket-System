...
|---|---|---|
| `registration.confirmed` | Outbox event (incremental) | `event_id`, `registration_id`, `employee_department`, `occurred_at` |
| `registration.cancelled` | Outbox event (incremental) | `event_id`, `registration_id`, `occurred_at` |
| `registration.waitlisted` | Outbox event (incremental) | `event_id`, `registration_id`, `occurred_at` |
| `registration.promoted` | Outbox event (incremental) | `event_id`, `registration_id`, `employee_department`, `occurred_at` |
